/* eslint-disable */
// Captured from a live Istio 1.30.1 ambient cluster (kind), so these are the
// exact shapes the API server returns, defaults and all -- not hand-written
// approximations of the CRD schemas.
  ...
  },
  {
    ...
    status: {
      ...
      conditions: [
        {
          lastProbeTime: null,
          lastTransitionTime: '2026-09-17T02:32:00Z',
          observedGeneration: 1,
          status: 'True',
          type: 'PodReadyToStartContainers',
        },
        ...
        {
          lastProbeTime: null,
          lastTransitionTime: '2026-09-17T02:32:12Z',
          observedGeneration: 1,
          status: 'True',
          type: 'Ready',
        },
      ...
      containerStatuses: [
        {
          ...
          containerID:
            'containerd://37332a5c92ce83fbdb97d3ab92a7bacbb54b500693990f6c92fce9b41c2db3b3',
          image: 'docker.io/istio/install-cni:1.30.1-distroless',
          imageID:
            'docker.io/istio/install-cni@sha256:77e5a27b2da2e17e5846d8ce604aaa2cf189e0e1932e6fd2292ad7826fd1761a',
          lastState: {},
          ...
          state: {
            running: {
              startedAt: '2026-09-17T02:32:11Z',
            },
          },
          user: {
            linux: {
  ...
  },
  {
    ...
    status: {
      ...
      conditions: [
        ...
        {
          lastProbeTime: null,
          lastTransitionTime: '2026-09-17T02:32:35Z',
          observedGeneration: 1,
          status: 'True',
          type: 'Ready',
        },
      ...
      containerStatuses: [
        {
          ...
          containerID:
            'containerd://8f0afa7d0b6b97a96ea83a1ac3e43f8fd4e872a30b5589ac3917adcea856a75c',
          image: 'docker.io/istio/ztunnel:1.30.1-distroless',
          imageID:
            'docker.io/istio/ztunnel@sha256:d13b16b40a4439c3831f06f22e8cfd3d58cb24cd0147ef9f5c831c227ea86121',
          lastState: {},
          ...
          state: {
            running: {
              startedAt: '2026-09-17T02:32:34Z',
            },
          },
          user: {
            linux: {
